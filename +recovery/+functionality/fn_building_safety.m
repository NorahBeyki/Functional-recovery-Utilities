...
for tu = 1:num_units
    ...
    if fs_exists
        ...
        for i=1:num_reals
            ...
            if utilities.water.state(i) == "SEQ1"                   %for all occupancies (multi or single unit), LQ service of plumbing does not meet tenant requirements
        ...
        system_operation_day.building.fire = max(system_operation_day.building.fire,Water(:,tu));
